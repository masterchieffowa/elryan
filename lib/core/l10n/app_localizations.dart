...
class AppLocalizations {
  ...
  // General
  String get appName => isArabic ? 'إدارة محل الصيانة' : 'Repair Shop Manager';
  ...
  String get incorrectPassword => isArabic ? 'كلمة مرور خاطئة' : 'Incorrect Password';
  String get passwordChanged => isArabic ? 'تم تغيير كلمة المرور' : 'Password Changed';
  ...
  String get outstandingBalance => isArabic ? 'المبالغ المستحقة' : 'Outstanding Balance';
  ...
  String get problemDescription => isArabic ? 'وصف المشكلة' : 'Problem Description';
  String get repairCost => isArabic ? 'تكلفة الإصلاح' : 'Repair Cost';
  String get paidAmount => isArabic ? 'المبلغ المدفوع' : 'Paid Amount';
  String get remainingAmount => isArabic ? 'المبلغ المتبقي' : 'Remaining Amount';
  ...
  String get accessoryNameAr => isArabic ? 'اسم الإكسسوار (عربي)' : 'Accessory Name (Arabic)';
  String get accessoryNameEn => isArabic ? 'اسم الإكسسوار (إنجليزي)' : 'Accessory Name (English)';
  ...
  String get pendingOrdersReport => isArabic ? 'تقرير الطلبات المعلقة' : 'Pending Orders Report';
  String get customerBalances => isArabic ? 'أرصدة العملاء' : 'Customer Balances';
  ...
  String get backupDatabase => isArabic ? 'نسخ قاعدة البيانات' : 'Backup Database';
  String get restoreDatabase => isArabic ? 'استعادة قاعدة البيانات' : 'Restore Database';
  ...
  String get deleteConfirm => isArabic ? 'هل أنت متأكد من الحذف؟' : 'Are you sure you want to delete?';
  ...
  String get passwordMismatch => isArabic ? 'كلمات المرور غير متطابقة' : 'Passwords do not match';
